...
/**
 * Social platform icons. Lucide no longer ships brand icons, so the brand
 * marks are inlined (filled 24×24 paths); "website" uses lucide's Globe.
 */
  ...
  return (
    ...
    >
      {platform === "website" ? (
        ...
        <BrandIcon path={BRAND_PATHS[platform]} className="size-4" />
      )}
    </a>
  );
}
